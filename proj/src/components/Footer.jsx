        ...
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            ...
            className='text-gray-600 dark:text-gray-400'>
                ...
                <div className='flex gap-2 text-sm'>
                    <input type="email" placeholder='Enter your email' className='w-full p-3 outline-none rounded-lg
                    dark:text-gray-200 bg-transparent border border-gray-300 dark:border-gray-500'/>
                    <button className='bg-primary text-white rounded px-6 hover:scale-103 transition-all cursor-pointer'>Subscribe</button>
                </div>
